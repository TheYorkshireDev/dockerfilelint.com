...
ace.define('ace/mode/dockerfile_highlight_rules', ['require', 'exports', 'module', 'ace/lib/oop', 'ace/mode/text_highlight_rules'], function (acequire, exports, module) {
  ...
  var DockerfileHighlightRules = function() {
    ...
    this.$rules = {
      start: [{
        ...
        regex: /^(\s*)(?:(ONBUILD)(\s+))?(ADD|ARG|CMD|COPY|ENTRYPOINT|ENV|EXPOSE|FROM|HEALTHCHECK|LABEL|MAINTAINER|RUN|SHELL|STOPSIGNAL|USER|VOLUME|WORKDIR)(\s)/,
        caseInsensitive: true
      }, {
        token: [
          'text',
        ...
        regex: /^(\s*)(?:(ONBUILD)(\s+))?(CMD|ENTRYPOINT)(\s)/,
        caseInsensitive: true
      }, {
        ...
        push: [{
          ...
          token: 'constant.character.escaped.dockerfile',
          regex: /\\./
        }, {
          defaultToken: 'string.quoted.double.dockerfile'
        }]
      }, {
        ...
        push: [{
          ...
          defaultToken: 'string.quoted.single.dockerfile'
        }]
      }, {
        token: [
  ...
  DockerfileHighlightRules.metaData = {
